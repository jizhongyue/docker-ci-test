...
CREATE DATABASE IF NOT EXISTS `dcr_pool_main_db` DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
USE dcr_pool_main_db;
...
CREATE TABLE `found_blocks` (
  ...
  `rewards_without_fee` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE `mining_workers` (
  ...
  `accept_1d` bigint(20) NOT NULL DEFAULT '0',
  `reject_1d` bigint(20) NOT NULL DEFAULT '0',
  `accept_count` int(11) NOT NULL DEFAULT '0',
  `last_share_ip` char(16) NOT NULL DEFAULT '0.0.0.0',
  `last_share_time` timestamp NOT NULL DEFAULT 0,
  `session_first_share_time` timestamp NOT NULL DEFAULT 0,
